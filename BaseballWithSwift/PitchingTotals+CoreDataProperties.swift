//
//  PitchingTotals+CoreDataProperties.swift
//  BaseballWithSwift
//
...
extension PitchingTotals {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<PitchingTotals> {
        return NSFetchRequest<PitchingTotals>(entityName: "PitchingTotals")
    }
