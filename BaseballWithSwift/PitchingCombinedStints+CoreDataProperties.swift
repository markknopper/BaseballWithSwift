//
//  PitchingCombinedStints+CoreDataProperties.swift
//  BaseballWithSwift
//
//  Created by Mark Knopper on 4/15/18.
...
extension PitchingCombinedStints {

    @nonobjc public class func fetchRequest() -> NSFetchRequest<PitchingCombinedStints> {
        return NSFetchRequest<PitchingCombinedStints>(entityName: "PitchingCombinedStints")
    }
